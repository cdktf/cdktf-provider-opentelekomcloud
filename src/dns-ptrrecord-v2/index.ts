// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.16/docs/resources/dns_ptrrecord_v2
...
export class DnsPtrrecordV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsPtrrecordV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.16/docs/resources/dns_ptrrecord_v2#import import section} in the documentation of this resource for the id to use
