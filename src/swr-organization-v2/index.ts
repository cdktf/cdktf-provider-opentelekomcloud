// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.19/docs/resources/swr_organization_v2
...
export class SwrOrganizationV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwrOrganizationV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.19/docs/resources/swr_organization_v2#import import section} in the documentation of this resource for the id to use
