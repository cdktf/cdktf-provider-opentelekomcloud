...
export function wafFalsealarmmaskingRuleV1TimeoutsToTerraform(struct?: WafFalsealarmmaskingRuleV1TimeoutsOutputReference | WafFalsealarmmaskingRuleV1Timeouts): any {
...
export class WafFalsealarmmaskingRuleV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: WafFalsealarmmaskingRuleV1Timeouts | undefined) {
    if (value === undefined) {
...
export class WafFalsealarmmaskingRuleV1 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new WafFalsealarmmaskingRuleV1TimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
