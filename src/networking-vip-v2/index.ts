...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.7/docs/resources/networking_vip_v2
...
export class NetworkingVipV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkingVipV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.7/docs/resources/networking_vip_v2#import import section} in the documentation of this resource for the id to use
