...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.8/docs/resources/dms_user_permission_v1
...
export class DmsUserPermissionV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsUserPermissionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.8/docs/resources/dms_user_permission_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.8/docs/resources/dms_user_permission_v1 opentelekomcloud_dms_user_permission_v1} Resource
  *
  * @param scope The scope in which to define this construct
