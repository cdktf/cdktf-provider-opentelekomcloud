// https://www.terraform.io/docs/providers/opentelekomcloud/r/lb_loadbalancer_v2
...
export function lbLoadbalancerV2TimeoutsToTerraform(struct?: LbLoadbalancerV2TimeoutsOutputReference | LbLoadbalancerV2Timeouts | cdktf.IResolvable): any {
...
export class LbLoadbalancerV2TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LbLoadbalancerV2Timeouts | undefined {
  ...
  public set internalValue(value: LbLoadbalancerV2Timeouts | undefined) {
    if (value === undefined) {
...
export class LbLoadbalancerV2 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LbLoadbalancerV2TimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
