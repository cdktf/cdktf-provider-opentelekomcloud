...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/dds_instance_v3
...
export class DdsInstanceV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdsInstanceV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/dds_instance_v3#import import section} in the documentation of this resource for the id to use
