...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.7/docs/resources/sdrs_replication_pair_v1
...
export class SdrsReplicationPairV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SdrsReplicationPairV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.7/docs/resources/sdrs_replication_pair_v1#import import section} in the documentation of this resource for the id to use
