...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.54/docs/resources/gaussdb_mysql_instance_v3
...
export function gaussdbMysqlInstanceV3BackupStrategyToTerraform(struct?: GaussdbMysqlInstanceV3BackupStrategyOutputReference | GaussdbMysqlInstanceV3BackupStrategy): any {
  ...
  return {
    keep_days: cdktf.stringToTerraform(struct!.keepDays),
...
export function gaussdbMysqlInstanceV3BackupStrategyToHclTerraform(struct?: GaussdbMysqlInstanceV3BackupStrategyOutputReference | GaussdbMysqlInstanceV3BackupStrategy): any {
  ...
  const attrs = {
    keep_days: {
      value: cdktf.stringToHclTerraform(struct!.keepDays),
      isBlock: false,
      type: "simple",
...
export class GaussdbMysqlInstanceV3BackupStrategyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _keepDays?: string; 
  public get keepDays() {
    return this.getStringAttribute('keep_days');
  }
  public set keepDays(value: string) {
...
export class GaussdbMysqlInstanceV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaussdbMysqlInstanceV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.54/docs/resources/gaussdb_mysql_instance_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.54/docs/resources/gaussdb_mysql_instance_v3 opentelekomcloud_gaussdb_mysql_instance_v3} Resource
  *
  * @param scope The scope in which to define this construct
