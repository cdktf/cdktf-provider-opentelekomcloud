...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.26/docs/resources/er_propagation_v3
...
export class ErPropagationV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ErPropagationV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.26/docs/resources/er_propagation_v3#import import section} in the documentation of this resource for the id to use
