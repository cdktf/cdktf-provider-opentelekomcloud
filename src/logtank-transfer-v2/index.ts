// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.15/docs/resources/logtank_transfer_v2
...
export class LogtankTransferV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogtankTransferV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.15/docs/resources/logtank_transfer_v2#import import section} in the documentation of this resource for the id to use
