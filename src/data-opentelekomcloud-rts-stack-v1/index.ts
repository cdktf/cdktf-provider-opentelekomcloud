// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.0/docs/data-sources/rts_stack_v1
...
export class DataOpentelekomcloudRtsStackV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudRtsStackV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.0/docs/data-sources/rts_stack_v1#import import section} in the documentation of this resource for the id to use
