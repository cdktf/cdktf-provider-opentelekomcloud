...
export function natGatewayV2TimeoutsToTerraform(struct?: NatGatewayV2TimeoutsOutputReference | NatGatewayV2Timeouts): any {
...
export class NatGatewayV2 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new NatGatewayV2TimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
