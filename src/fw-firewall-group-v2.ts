// https://www.terraform.io/docs/providers/opentelekomcloud/r/fw_firewall_group_v2
...
export function fwFirewallGroupV2TimeoutsToTerraform(struct?: FwFirewallGroupV2TimeoutsOutputReference | FwFirewallGroupV2Timeouts | cdktf.IResolvable): any {
...
export class FwFirewallGroupV2 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new FwFirewallGroupV2TimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
