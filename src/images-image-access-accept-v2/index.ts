// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.10/docs/resources/images_image_access_accept_v2
...
export class ImagesImageAccessAcceptV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagesImageAccessAcceptV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.10/docs/resources/images_image_access_accept_v2#import import section} in the documentation of this resource for the id to use
