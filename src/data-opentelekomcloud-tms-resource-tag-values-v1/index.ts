...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.53/docs/data-sources/tms_resource_tag_values_v1
...
export class DataOpentelekomcloudTmsResourceTagValuesV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudTmsResourceTagValuesV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.53/docs/data-sources/tms_resource_tag_values_v1#import import section} in the documentation of this resource for the id to use
