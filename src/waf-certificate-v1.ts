// https://www.terraform.io/docs/providers/opentelekomcloud/r/waf_certificate_v1
...
export class WafCertificateV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WafCertificateV1Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: WafCertificateV1Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class WafCertificateV1 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opentelekomcloud_waf_certificate_v1";
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/opentelekomcloud/r/waf_certificate_v1 opentelekomcloud_waf_certificate_v1} Resource
  *
  ...
  */
  ...
  private _timeouts = new WafCertificateV1TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
