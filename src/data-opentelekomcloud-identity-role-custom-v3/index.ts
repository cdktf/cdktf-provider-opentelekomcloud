...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.41/docs/data-sources/identity_role_custom_v3
...
export class DataOpentelekomcloudIdentityRoleCustomV3 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudIdentityRoleCustomV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.41/docs/data-sources/identity_role_custom_v3#import import section} in the documentation of this resource for the id to use
