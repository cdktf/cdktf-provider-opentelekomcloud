...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/as_lifecycle_hook_v1
...
export class AsLifecycleHookV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsLifecycleHookV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/as_lifecycle_hook_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/as_lifecycle_hook_v1 opentelekomcloud_as_lifecycle_hook_v1} Resource
  *
  * @param scope The scope in which to define this construct
