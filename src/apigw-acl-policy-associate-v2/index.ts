// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.15/docs/resources/apigw_acl_policy_associate_v2
...
export class ApigwAclPolicyAssociateV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigwAclPolicyAssociateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.15/docs/resources/apigw_acl_policy_associate_v2#import import section} in the documentation of this resource for the id to use
