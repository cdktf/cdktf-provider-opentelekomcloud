...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.14/docs
...
export class OpentelekomcloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OpentelekomcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.14/docs#import import section} in the documentation of this resource for the id to use
