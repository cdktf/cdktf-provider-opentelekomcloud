// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.1/docs/resources/csbs_backup_v1
...
export class CsbsBackupV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsbsBackupV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.1/docs/resources/csbs_backup_v1#import import section} in the documentation of this resource for the id to use
