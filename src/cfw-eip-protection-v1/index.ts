...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/cfw_eip_protection_v1
...
export class CfwEipProtectionV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwEipProtectionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/cfw_eip_protection_v1#import import section} in the documentation of this resource for the id to use
