...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.12/docs/resources/dms_user_v2
...
export class DmsUserV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsUserV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.35.12/docs/resources/dms_user_v2#import import section} in the documentation of this resource for the id to use
