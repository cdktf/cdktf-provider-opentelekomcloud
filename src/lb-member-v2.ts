...
export function lbMemberV2TimeoutsToTerraform(struct?: LbMemberV2TimeoutsOutputReference | LbMemberV2Timeouts): any {
...
export class LbMemberV2 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LbMemberV2TimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
