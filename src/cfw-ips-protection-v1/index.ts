...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.42/docs/resources/cfw_ips_protection_v1
...
export class CfwIpsProtectionV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwIpsProtectionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.42/docs/resources/cfw_ips_protection_v1#import import section} in the documentation of this resource for the id to use
