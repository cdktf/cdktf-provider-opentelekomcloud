// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/deh_host_v1
...
export class DataOpentelekomcloudDehHostV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudDehHostV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/deh_host_v1#import import section} in the documentation of this resource for the id to use
