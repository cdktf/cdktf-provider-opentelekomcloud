...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.48/docs/resources/er_instance_v3
...
export class ErInstanceV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ErInstanceV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.48/docs/resources/er_instance_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.48/docs/resources/er_instance_v3 opentelekomcloud_er_instance_v3} Resource
  *
  * @param scope The scope in which to define this construct
