...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/compute_bms_flavors_v2
...
export class DataOpentelekomcloudComputeBmsFlavorsV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudComputeBmsFlavorsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/compute_bms_flavors_v2#import import section} in the documentation of this resource for the id to use
