...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.43/docs/resources/dds_lts_log_v3
...
export interface DdsLtsLogV3Config extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.43/docs/resources/dds_lts_log_v3#lts_group_id DdsLtsLogV3#lts_group_id}
  */
...
export class DdsLtsLogV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdsLtsLogV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.43/docs/resources/dds_lts_log_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.43/docs/resources/dds_lts_log_v3 opentelekomcloud_dds_lts_log_v3} Resource
  *
  * @param scope The scope in which to define this construct
