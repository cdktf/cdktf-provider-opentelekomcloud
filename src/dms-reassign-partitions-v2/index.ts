// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.31/docs/resources/dms_reassign_partitions_v2
...
export class DmsReassignPartitionsV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsReassignPartitionsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.31/docs/resources/dms_reassign_partitions_v2#import import section} in the documentation of this resource for the id to use
