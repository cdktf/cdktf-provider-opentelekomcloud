...
// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/identity_projects_v3
...
export interface DataOpentelekomcloudIdentityProjectsV3Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/identity_projects_v3#id DataOpentelekomcloudIdentityProjectsV3#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/identity_projects_v3 opentelekomcloud_identity_projects_v3}
*/
export class DataOpentelekomcloudIdentityProjectsV3 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudIdentityProjectsV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/identity_projects_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.29/docs/data-sources/identity_projects_v3 opentelekomcloud_identity_projects_v3} Data Source
  *
  * @param scope The scope in which to define this construct
