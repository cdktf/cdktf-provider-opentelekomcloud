// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.28/docs/resources/kms_key_material_v1
...
export class KmsKeyMaterialV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsKeyMaterialV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.28/docs/resources/kms_key_material_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.28/docs/resources/kms_key_material_v1 opentelekomcloud_kms_key_material_v1} Resource
  *
  * @param scope The scope in which to define this construct
