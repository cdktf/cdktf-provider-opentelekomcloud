...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/blockstoragevolumev2"
...
&blockstoragevolumev2.BlockstorageVolumeV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.blockstorageVolumeV2.BlockstorageVolumeV2Timeouts,
	VolumeType: *string,
}
```
