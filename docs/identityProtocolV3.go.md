...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/identityprotocolv3"
...
&identityprotocolv3.IdentityProtocolV3Config {
	...
	ProviderId: *string,
	Id: *string,
	Metadata: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.identityProtocolV3.IdentityProtocolV3Metadata,
}
```
