...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/identityprotocolv3"
...
&identityprotocolv3.IdentityProtocolV3Config {
	...
	ProviderId: *string,
	Id: *string,
	Metadata: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.identityProtocolV3.IdentityProtocolV3Metadata,
}
```
