...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8/sdrsprotectedinstancev1"
...
&sdrsprotectedinstancev1.SdrsProtectedInstanceV1Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8.sdrsProtectedInstanceV1.SdrsProtectedInstanceV1Timeouts,
}
```
