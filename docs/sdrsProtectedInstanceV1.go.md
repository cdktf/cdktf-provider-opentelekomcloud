...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/sdrsprotectedinstancev1"
...
&sdrsprotectedinstancev1.SdrsProtectedInstanceV1Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.sdrsProtectedInstanceV1.SdrsProtectedInstanceV1Timeouts,
}
```
