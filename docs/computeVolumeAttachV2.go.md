...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/computevolumeattachv2"
...
&computevolumeattachv2.ComputeVolumeAttachV2Config {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.computeVolumeAttachV2.ComputeVolumeAttachV2Timeouts,
}
```
