...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/computevolumeattachv2"
...
&computevolumeattachv2.ComputeVolumeAttachV2Config {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.computeVolumeAttachV2.ComputeVolumeAttachV2Timeouts,
}
```
