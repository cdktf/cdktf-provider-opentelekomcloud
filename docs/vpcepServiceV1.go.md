...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/vpcepservicev1"
...
&vpcepservicev1.VpcepServiceV1Config {
	...
	TcpProxy: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.vpcepServiceV1.VpcepServiceV1Timeouts,
	VipPortId: *string,
}
```
