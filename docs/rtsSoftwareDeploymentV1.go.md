...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/rtssoftwaredeploymentv1"
...
&rtssoftwaredeploymentv1.RtsSoftwareDeploymentV1Config {
	...
	StatusReason: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.rtsSoftwareDeploymentV1.RtsSoftwareDeploymentV1Timeouts,
}
```
