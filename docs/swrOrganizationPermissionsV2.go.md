...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/swrorganizationpermissionsv2"
...
&swrorganizationpermissionsv2.SwrOrganizationPermissionsV2Config {
	...
	Username: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.swrOrganizationPermissionsV2.SwrOrganizationPermissionsV2Timeouts,
}
```
