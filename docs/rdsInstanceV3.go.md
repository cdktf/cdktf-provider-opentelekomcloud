...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/rdsinstancev3"
...
&rdsinstancev3.RdsInstanceV3Config {
	...
	Db: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.rdsInstanceV3.RdsInstanceV3Db,
	Flavor: *string,
	Name: *string,
	SecurityGroupId: *string,
	SubnetId: *string,
	Volume: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.rdsInstanceV3.RdsInstanceV3Volume,
	VpcId: *string,
	BackupStrategy: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.rdsInstanceV3.RdsInstanceV3BackupStrategy,
	HaReplicationMode: *string,
	Id: *string,
	Parameters: *map[string]*string,
	ParamGroupId: *string,
	PublicIps: *[]*string,
	RestorePoint: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.rdsInstanceV3.RdsInstanceV3RestorePoint,
	SslEnable: interface{},
	Tag: *map[string]*string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.rdsInstanceV3.RdsInstanceV3Timeouts,
}
```
