...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6/vpcpeeringconnectionv2"
...
&vpcpeeringconnectionv2.VpcPeeringConnectionV2Config {
	...
	PeerTenantId: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6.vpcPeeringConnectionV2.VpcPeeringConnectionV2Timeouts,
}
```
