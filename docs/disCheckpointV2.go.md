...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/discheckpointv2"
...
&discheckpointv2.DisCheckpointV2Config {
	...
	Id: *string,
	Metadata: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.disCheckpointV2.DisCheckpointV2Timeouts,
}
```
