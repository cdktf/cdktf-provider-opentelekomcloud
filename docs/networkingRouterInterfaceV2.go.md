...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/networkingrouterinterfacev2"
...
&networkingrouterinterfacev2.NetworkingRouterInterfaceV2Config {
	...
	Region: *string,
	SubnetId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.networkingRouterInterfaceV2.NetworkingRouterInterfaceV2Timeouts,
}
```
