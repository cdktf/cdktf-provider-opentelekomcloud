...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/dataopentelekomcloudtaurusdbmysqlproxyflavorsv3"
...
```go
func Flavors() DataOpentelekomcloudTaurusdbMysqlProxyFlavorsV3FlavorGroupsFlavorsList
```
...
```go
func InternalValue() DataOpentelekomcloudTaurusdbMysqlProxyFlavorsV3FlavorGroups
```
