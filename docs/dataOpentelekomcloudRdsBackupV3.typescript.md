...
new dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3(scope: Construct, id: string, config: DataOpentelekomcloudRdsBackupV3Config)
```
...
dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.isConstruct(x: any)
```
...
dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.isTerraformElement(x: any)
```
...
dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.isTerraformDataSource(x: any)
```
...
dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3.property.size">size</a></code> | <code>number</code> | *No description.* |
...
const dataOpentelekomcloudRdsBackupV3Config: dataOpentelekomcloudRdsBackupV3.DataOpentelekomcloudRdsBackupV3Config = { ... }
```
