...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/imsimagev2"
...
&imsimagev2.ImsImageV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.imsImageV2.ImsImageV2Timeouts,
	Type: *string,
	VolumeId: *string,
}
```
