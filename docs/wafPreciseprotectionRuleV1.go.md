...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/wafpreciseprotectionrulev1"
...
&wafpreciseprotectionrulev1.WafPreciseprotectionRuleV1Config {
	...
	Start: *string,
	Time: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.wafPreciseprotectionRuleV1.WafPreciseprotectionRuleV1Timeouts,
}
```
