...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/wafpreciseprotectionrulev1"
...
&wafpreciseprotectionrulev1.WafPreciseprotectionRuleV1Config {
	...
	Start: *string,
	Time: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.wafPreciseprotectionRuleV1.WafPreciseprotectionRuleV1Timeouts,
}
```
