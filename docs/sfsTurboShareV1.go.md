...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/sfsturbosharev1"
...
&sfsturbosharev1.SfsTurboShareV1Config {
	...
	ShareProto: *string,
	ShareType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.sfsTurboShareV1.SfsTurboShareV1Timeouts,
}
```
