...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8/wafwebtamperprotectionrulev1"
...
&wafwebtamperprotectionrulev1.WafWebtamperprotectionRuleV1Config {
	...
	Url: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8.wafWebtamperprotectionRuleV1.WafWebtamperprotectionRuleV1Timeouts,
}
```
