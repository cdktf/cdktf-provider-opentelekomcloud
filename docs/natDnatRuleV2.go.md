...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/natdnatrulev2"
...
&natdnatrulev2.NatDnatRuleV2Config {
	...
	PortId: *string,
	PrivateIp: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.natDnatRuleV2.NatDnatRuleV2Timeouts,
}
```
