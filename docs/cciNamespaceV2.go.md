...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/ccinamespacev2"
...
&ccinamespacev2.CciNamespaceV2Config {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud.cciNamespaceV2.CciNamespaceV2Timeouts,
}
```
