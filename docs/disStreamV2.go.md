...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/disstreamv2"
...
&disstreamv2.DisStreamV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.disStreamV2.DisStreamV2Timeouts,
}
```
