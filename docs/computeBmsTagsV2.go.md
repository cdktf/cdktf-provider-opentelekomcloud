...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8/computebmstagsv2"
...
&computebmstagsv2.ComputeBmsTagsV2Config {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8.computeBmsTagsV2.ComputeBmsTagsV2Timeouts,
}
```
