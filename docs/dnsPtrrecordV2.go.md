...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/dnsptrrecordv2"
...
&dnsptrrecordv2.DnsPtrrecordV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.dnsPtrrecordV2.DnsPtrrecordV2Timeouts,
	Ttl: *f64,
}
```
