...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6/networkingsecgrouprulev2"
...
&networkingsecgrouprulev2.NetworkingSecgroupRuleV2Config {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6.networkingSecgroupRuleV2.NetworkingSecgroupRuleV2Timeouts,
}
```
