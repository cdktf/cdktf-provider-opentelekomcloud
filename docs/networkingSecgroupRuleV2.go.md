...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/networkingsecgrouprulev2"
...
&networkingsecgrouprulev2.NetworkingSecgroupRuleV2Config {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.networkingSecgroupRuleV2.NetworkingSecgroupRuleV2Timeouts,
}
```
