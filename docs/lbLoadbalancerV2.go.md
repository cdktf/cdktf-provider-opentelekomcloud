...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/lbloadbalancerv2"
...
&lbloadbalancerv2.LbLoadbalancerV2Config {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.lbLoadbalancerV2.LbLoadbalancerV2Timeouts,
	VipAddress: *string,
}
```
