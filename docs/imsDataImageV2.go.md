...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/imsdataimagev2"
...
&imsdataimagev2.ImsDataImageV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.imsDataImageV2.ImsDataImageV2Timeouts,
	VolumeId: *string,
}
```
