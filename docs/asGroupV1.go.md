...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/asgroupv1"
...
&asgroupv1.AsGroupV1Config {
	...
	SecurityGroups: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.asGroupV1.AsGroupV1SecurityGroups,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.asGroupV1.AsGroupV1Timeouts,
}
```
