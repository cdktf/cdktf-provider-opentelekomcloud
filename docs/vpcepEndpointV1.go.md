...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/vpcependpointv1"
...
&vpcependpointv1.VpcepEndpointV1Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.vpcepEndpointV1.VpcepEndpointV1Timeouts,
	Whitelist: *[]*string,
}
```
