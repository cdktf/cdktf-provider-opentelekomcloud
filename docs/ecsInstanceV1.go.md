...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/ecsinstancev1"
...
&ecsinstancev1.EcsInstanceV1Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.ecsInstanceV1.EcsInstanceV1Timeouts,
	UserData: *string,
}
```
