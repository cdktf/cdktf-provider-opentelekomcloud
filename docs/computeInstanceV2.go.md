...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/computeinstancev2"
...
&computeinstancev2.ComputeInstanceV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.computeInstanceV2.ComputeInstanceV2Timeouts,
	UserData: *string,
}
```
