...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/swrrepositoryv2"
...
&swrrepositoryv2.SwrRepositoryV2Config {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.swrRepositoryV2.SwrRepositoryV2Timeouts,
}
```
