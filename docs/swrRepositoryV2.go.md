...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8/swrrepositoryv2"
...
&swrrepositoryv2.SwrRepositoryV2Config {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8.swrRepositoryV2.SwrRepositoryV2Timeouts,
}
```
