...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/sdrsprotectiongroupv1"
...
&sdrsprotectiongroupv1.SdrsProtectiongroupV1Config {
	...
	DrType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.sdrsProtectiongroupV1.SdrsProtectiongroupV1Timeouts,
}
```
