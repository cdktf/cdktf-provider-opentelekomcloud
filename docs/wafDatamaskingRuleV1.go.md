...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/wafdatamaskingrulev1"
...
&wafdatamaskingrulev1.WafDatamaskingRuleV1Config {
	...
	Url: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.wafDatamaskingRuleV1.WafDatamaskingRuleV1Timeouts,
}
```
