...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/sfsfilesystemv2"
...
&sfsfilesystemv2.SfsFileSystemV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.sfsFileSystemV2.SfsFileSystemV2Timeouts,
}
```
