...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/wafcertificatev1"
...
&wafcertificatev1.WafCertificateV1Config {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud.wafCertificateV1.WafCertificateV1Timeouts,
}
```
