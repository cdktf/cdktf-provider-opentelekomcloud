...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6/wafcertificatev1"
...
| <code><a href="#@cdktf/provider-opentelekomcloud.wafCertificateV1.WafCertificateV1.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&wafcertificatev1.WafCertificateV1Config {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6.wafCertificateV1.WafCertificateV1Timeouts,
}
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.wafCertificateV1.WafCertificateV1Config.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
