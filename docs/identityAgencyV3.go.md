...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/identityagencyv3"
...
&identityagencyv3.IdentityAgencyV3Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.identityAgencyV3.IdentityAgencyV3Timeouts,
}
```
