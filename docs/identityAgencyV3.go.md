...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9/identityagencyv3"
...
&identityagencyv3.IdentityAgencyV3Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v9.identityAgencyV3.IdentityAgencyV3Timeouts,
}
```
