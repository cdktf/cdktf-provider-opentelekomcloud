...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/identityagencyv3"
...
&identityagencyv3.IdentityAgencyV3Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud.identityAgencyV3.IdentityAgencyV3Timeouts,
}
```
