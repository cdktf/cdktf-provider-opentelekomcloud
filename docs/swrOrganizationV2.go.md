...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/swrorganizationv2"
...
&swrorganizationv2.SwrOrganizationV2Config {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.swrOrganizationV2.SwrOrganizationV2Timeouts,
}
```
