...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/vpcflowlogv1"
...
&vpcflowlogv1.VpcFlowLogV1Config {
	...
	Name: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.vpcFlowLogV1.VpcFlowLogV1Timeouts,
}
```
