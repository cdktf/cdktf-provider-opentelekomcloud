...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/lbcertificatev2"
...
&lbcertificatev2.LbCertificateV2Config {
	...
	PrivateKey: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.lbCertificateV2.LbCertificateV2Timeouts,
	Type: *string,
}
```
