...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/mrsclusterv1"
...
&mrsclusterv1.MrsClusterV1Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.mrsClusterV1.MrsClusterV1Timeouts,
	VolumeSize: *f64,
	VolumeType: *string,
}
```
