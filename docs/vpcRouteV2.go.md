...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8/vpcroutev2"
...
&vpcroutev2.VpcRouteV2Config {
	...
	Region: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v8.vpcRouteV2.VpcRouteV2Timeouts,
}
```
