...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5/vpcroutev2"
...
&vpcroutev2.VpcRouteV2Config {
	...
	Region: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v5.vpcRouteV2.VpcRouteV2Timeouts,
}
```
