...
```typescript
public readonly flavors: DataOpentelekomcloudTaurusdbMysqlProxyFlavorsV3FlavorGroupsFlavorsList;
```
...
```typescript
public readonly internalValue: DataOpentelekomcloudTaurusdbMysqlProxyFlavorsV3FlavorGroups;
```
