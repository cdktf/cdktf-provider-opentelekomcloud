...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7/dmsinstancev2"
...
&dmsinstancev2.DmsInstanceV2Config {
	...
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v7.dmsInstanceV2.DmsInstanceV2Timeouts,
}
```
