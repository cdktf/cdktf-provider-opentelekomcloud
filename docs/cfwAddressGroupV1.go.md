...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/cfwaddressgroupv1"
...
&cfwaddressgroupv1.CfwAddressGroupV1Config {
	...
	AddressType: *f64,
	Description: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud.cfwAddressGroupV1.CfwAddressGroupV1Timeouts,
}
```
