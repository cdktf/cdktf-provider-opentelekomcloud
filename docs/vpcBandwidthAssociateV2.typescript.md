...
new vpcBandwidthAssociateV2.VpcBandwidthAssociateV2(scope: Construct, id: string, config: VpcBandwidthAssociateV2Config)
```
...
```typescript
public resetBackupChargeMode(): void
```
...
vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.isConstruct(x: any)
```
...
vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.isTerraformElement(x: any)
```
...
vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.isTerraformResource(x: any)
```
...
vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.property.backupSizeInput">backupSizeInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2.property.backupSize">backupSize</a></code> | <code>number</code> | *No description.* |
...
const vpcBandwidthAssociateV2Config: vpcBandwidthAssociateV2.VpcBandwidthAssociateV2Config = { ... }
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.vpcBandwidthAssociateV2.VpcBandwidthAssociateV2Config.property.bandwidth">bandwidth</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.17/docs/resources/vpc_bandwidth_associate_v2#bandwidth VpcBandwidthAssociateV2#bandwidth}. |
