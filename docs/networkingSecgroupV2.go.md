...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6/networkingsecgroupv2"
...
&networkingsecgroupv2.NetworkingSecgroupV2Config {
	...
	Region: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v6.networkingSecgroupV2.NetworkingSecgroupV2Timeouts,
}
```
