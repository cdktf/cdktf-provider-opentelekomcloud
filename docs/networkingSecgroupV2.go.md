...
```go
import "github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12/networkingsecgroupv2"
...
&networkingsecgroupv2.NetworkingSecgroupV2Config {
	...
	Region: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12.networkingSecgroupV2.NetworkingSecgroupV2Timeouts,
}
```
