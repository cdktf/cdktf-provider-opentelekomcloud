...
new DataOpentelekomcloudGeminiTemplatesV3(Construct Scope, string Id, DataOpentelekomcloudGeminiTemplatesV3Config Config = null);
```
...
DataOpentelekomcloudGeminiTemplatesV3.IsConstruct(object X);
```
...
DataOpentelekomcloudGeminiTemplatesV3.IsTerraformElement(object X);
```
...
DataOpentelekomcloudGeminiTemplatesV3.IsTerraformDataSource(object X);
```
...
DataOpentelekomcloudGeminiTemplatesV3.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
```csharp
public DataOpentelekomcloudGeminiTemplatesV3TemplatesList Templates { get; }
```
...
new DataOpentelekomcloudGeminiTemplatesV3Config {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.connection">Connection</a></code> | <code>HashiCorp.Cdktf.SSHProvisionerConnection\|HashiCorp.Cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3Config.property.provisioners">Provisioners</a></code> | <code>HashiCorp.Cdktf.FileProvisioner\|HashiCorp.Cdktf.LocalExecProvisioner\|HashiCorp.Cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
new DataOpentelekomcloudGeminiTemplatesV3Templates {
...
new DataOpentelekomcloudGeminiTemplatesV3TemplatesList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesList.resolve.parameter._context"></a>
...
```csharp
private DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference Get(double Index)
```
...
new DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-opentelekomcloud.dataOpentelekomcloudGeminiTemplatesV3.DataOpentelekomcloudGeminiTemplatesV3TemplatesOutputReference.property.userDefined">UserDefined</a></code> | <code>HashiCorp.Cdktf.IResolvable</code> | *No description.* |
...
```csharp
public DataOpentelekomcloudGeminiTemplatesV3Templates InternalValue { get; }
```
