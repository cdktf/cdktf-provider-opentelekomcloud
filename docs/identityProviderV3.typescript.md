...
```typescript
import { identityProviderV3 } from '@cdktf/provider-opentelekomcloud'

new identityProviderV3.IdentityProviderV3(scope: Construct, id: string, config: IdentityProviderV3Config)
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.moveFromId"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.moveTo"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.moveToId"></a>
...
identityProviderV3.IdentityProviderV3.isConstruct(x: any)
```
...
identityProviderV3.IdentityProviderV3.isTerraformElement(x: any)
```
...
identityProviderV3.IdentityProviderV3.isTerraformResource(x: any)
```
...
identityProviderV3.IdentityProviderV3.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3.property.enabled">enabled</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
const identityProviderV3Config: identityProviderV3.IdentityProviderV3Config = { ... }
```
...
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3Config.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27/docs/resources/identity_provider_v3#name IdentityProviderV3#name}. |
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3Config.property.description">description</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27/docs/resources/identity_provider_v3#description IdentityProviderV3#description}. |
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3Config.property.enabled">enabled</a></code> | <code>boolean \| cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27/docs/resources/identity_provider_v3#enabled IdentityProviderV3#enabled}. |
| <code><a href="#@cdktf/provider-opentelekomcloud.identityProviderV3.IdentityProviderV3Config.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27/docs/resources/identity_provider_v3#id IdentityProviderV3#id}. |
